...
@interface ZWWebViewController ()<WKNavigationDelegate,WKUIDelegate>
...
-(void)initWKWebView
{
    ...
    _wkwebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, ZWStatusAndNavHeight, KScreenWidth, KScreenHeight - ZWStatusAndNavHeight) configuration:configuration];
