...
{
    NSString *path = message.slice.content;
    NSString *videoPath = message.slice.content;// 这是整个路径
...
{
    NSString *path = [[MMFileTool cacheDirectory] stringByAppendingPathComponent:kVideoPic];
    [self fileManagerWithPath:path];
                                     ...
                                     type:(NSString *)type
{
    ...
    NSString *mainFilePath = [self createFolderPahtWithMainFolder:[MMFileTool cacheDirectory] childFolder:kMyPic];
...
{
    return [[[MMFileTool cacheDirectory] stringByAppendingPathComponent:kMyPic] stringByAppendingPathComponent:imageName];
}
...
{
    return [[MMMediaManager sharedManager] receiveImagePathWithFileKey:messageF.aMessage.slice.content type:@"origin"];
}

// small image path
- (NSString *)smallImgPath:(NSString *)fileKey
{
    return [[MMMediaManager sharedManager] receiveImagePathWithFileKey:fileKey type:@"small"];
}
...
- (NSString *)delieveImagePath:(NSString *)fileKey
{
    ...
    NSString *mainFilePath = [self createFolderPahtWithMainFolder:[MMFileTool cacheDirectory] childFolder:kDeliver];
    return [mainFilePath stringByAppendingPathComponent:fileName];
}
