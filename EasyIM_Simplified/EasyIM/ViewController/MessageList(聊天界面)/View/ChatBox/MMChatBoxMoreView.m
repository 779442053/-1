...
@interface MMChatBoxMoreView() <UIScrollViewDelegate>
...
@implementation MMChatBoxMoreView
...
- (void)setItems:(NSMutableArray *)items
{
    ...
    int i = 0, page = 0;
    for (MMChatBoxMoreViewItem * item in _items) {
...
// 点击了某个Item
- (void) didSelectedItem:(MMChatBoxMoreViewItem *)sender
{
...
{
    [self.scrollView scrollRectToVisible:CGRectMake(pageControl.currentPage * KScreenWidth, 0, KScreenWidth, self.scrollView.height) animated:YES];
}
