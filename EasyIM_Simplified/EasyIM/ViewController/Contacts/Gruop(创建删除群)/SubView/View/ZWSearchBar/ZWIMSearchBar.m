...
@interface ZWIMSearchBar ()<UITextFieldDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self layoutUI];
        _barStyle = -1;
        [self setBarStyle:ZWBarStyleDefault];
    }
    return self;
}
- (void)layoutUI {
...
- (void)setBarStyle:(ZWBarStyle)barStyle {
    if (_barStyle != barStyle) {
        switch (barStyle) {
            case ZWBarStyleDefault:
            {
