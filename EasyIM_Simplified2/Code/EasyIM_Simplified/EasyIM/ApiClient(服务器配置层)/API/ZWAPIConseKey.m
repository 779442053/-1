...
NSString *const  setCoordinate = @"/api/user/setCoordinate";
...
NSString *const  add = @"/api/dept/add";
NSString *const  getToken = @"/api_im/getToken";
NSString *const  searchfriend = @"/api_im/friend/searchfriend";
NSString *const  usersig = @"/api/user/usersig";
NSString *const  getmemo = @"/api/friend/getmemo";
NSString *const  setmemo = @"/api/friend/setmemo";
NSString *const  getCoordinate = @"/api/user/getCoordinate";
NSString *const  getMulCoordinate = @"/api/user/getMulCoordinate";
NSString *const  searchUser = @"/api_im/user/searchUser";
NSString *const  getUserByDomain = @"/api/user/getUserByDomain";
