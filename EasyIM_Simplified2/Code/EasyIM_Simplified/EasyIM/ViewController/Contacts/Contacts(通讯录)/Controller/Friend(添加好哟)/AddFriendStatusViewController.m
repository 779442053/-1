...
- (UISearchBar *)searchBar{
    if (!_searchBar) {
        ...
        [_searchBar setPlaceholder:@"请输入好友账号/手机号"];
        //设置Placeholder字体大小
//        UITextField *textfield = [_searchBar valueForKey:@"_searchField"];
//        NSMutableAttributedString *placeholderString = [[NSMutableAttributedString alloc] initWithString:@"请输入好友账号/手机号" attributes:@{NSForegroundColorAttributeName : [UIColor colorWithHexString:@"#BABABA"],NSFontAttributeName:[UIFont systemFontOfSize:12.0]}];
...
{
    WEAKSELF
    [MMRequestManager fetchBulletionCompletion:^(NSArray<NewFriendModel *> * _Nonnull bulletionList, NSError * _Nonnull error) {
        if (!error) {
