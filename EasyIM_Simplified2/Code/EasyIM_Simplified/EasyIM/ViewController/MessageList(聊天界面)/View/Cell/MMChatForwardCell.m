...
#import "MMChatForwardCell.h"

#define headImageHeight 34
@interface MMChatForwardCell ()
...
@implementation MMChatForwardCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    MMChatForwardCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[MMChatForwardCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}
