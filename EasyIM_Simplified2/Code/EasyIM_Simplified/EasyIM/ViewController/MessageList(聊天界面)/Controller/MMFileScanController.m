...
@interface MMFileScanController ()<QLPreviewControllerDataSource,QLPreviewControllerDelegate,UIWebViewDelegate,UIDocumentInteractionControllerDelegate>

@property (nonatomic, weak) UIWebView *webView;
@property (nonatomic, strong) QLPreviewController *previewController;
@property (nonatomic, strong) NSURL *fileURL;
@property (nonatomic, strong) UIDocumentInteractionController *documentInCtr;
@property (nonatomic, weak) MMAudioView *audioView;


@end

@implementation MMFileScanController
...
{
    if ([type isEqualToString:@"html"] || [type isEqualToString:@"htm"]||[type isEqualToString:@"gif"]) {
        
        UIWebView *webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, ZWStatusAndNavHeight, self.view.width,KScreenHeight - ZWStatusAndNavHeight)];
...
//        [self.view addSubview:webView];
        ...
        _previewController.view.frame = CGRectMake(0,0, self.view.width, KScreenHeight);
    ...
    else if ([type isEqualToString:@"png"]||[type isEqualToString:@"jpg"]||[type isEqualToString:@"jpeg"]||[type isEqualToString:@"bmp"]||[type isEqualToString:@"tiff"]||[type isEqualToString:@"svg"]) {
        ...
        MMAudioView *audioView = [[MMAudioView alloc] initWithFrame:self.view.bounds];
...
- (void)makeOtherView
{
    ...
    UILabel *nameL      = [[UILabel alloc] initWithFrame:CGRectMake(KScreenWidth*0.5-150, imageV.bottom+32, 300, 40)];
    ...
    [nameL sizeToFit];
    nameL.centerX = KScreenWidth*0.5;
    
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(KScreenWidth*0.5-100, nameL.bottom+85, 200, 40)];
    ...
    openBtn.frame     = CGRectMake(13, label.bottom + 40, KScreenWidth-26, 48);
