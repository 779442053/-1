...
#import "MMPhotoBrowserController.h"

@interface MMPhotoBrowserController ()<UIScrollViewDelegate,UIActionSheetDelegate>
...
@implementation MMPhotoBrowserController
